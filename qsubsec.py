...
def main():
    ...
    submission_group.add_argument('-f', '--submission-format', dest='submission_format', default='qsub', choices=['qsub', 'bash'], help='the submission format to use when using -s')
    submission_group.add_argument('--submission-exec', dest='submission_exec', default=None, help='override the default executable to use when submitting with -s')
    submission_group.add_argument('--submission-timeout', dest='submission_timeout', default=20, type=int, help='submission timeout time when submitting with -s (default 20 sec)')
    ...
    output_excl.add_argument('-t', '--show-tokens', dest='show_tokens', action='store_true', default=False, help='show the tokens referred to in the template file')
    output_excl.add_argument('-d', '--describe-sections', dest='show_sections', action='store_true', default=False, help='describe the generated sections')
    output_excl.add_argument('-c', '--show-commands', dest='show_commands', action='store_true', default=False, help='show the commands to be executed')
